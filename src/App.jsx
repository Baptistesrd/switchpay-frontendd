...
import {
  ...
  Stat, StatLabel, StatNumber, SimpleGrid, useColorModeValue, Divider, HStack, Badge
      ...
      <Box position="relative" zIndex={1} maxW="7xl" mx="auto" px={6} py={16}>
        ...
        <Box textAlign="center" mb={16}>
          <Heading
            ...
            lineHeight="1.1"
          >
           Start a transaction <Box as="span" color="brand.500">now.</Box>
          </Heading>
          <Heading
            as="h2"
            mt={4}
          ...
          <HStack spacing={4} justify="center" mt={8}>
            ...
            <GhostMagneticButton>Contact us</GhostMagneticButton>
          </HStack>
        </Box>
            ...
            <TabPanel>
              <GlowCard p={6}>
                <HStack justify="space-between" mb={4} wrap="wrap" spacing={3}>
                  ...
                  <MagneticButton>Download CSV</MagneticButton>
                </HStack>
