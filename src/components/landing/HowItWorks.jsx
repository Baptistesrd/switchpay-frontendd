      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr" }}>
        {STEPS.map((step, i) => (
          ...
          >
            ...
            <p style={{ margin: "0 0 24px", fontFamily: "'DM Sans', sans-serif", fontSize: "11px", fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(255,255,255,0.2)" }}>
              {step.n}
            </p>
            <h3 style={{ margin: "0 0 16px", fontFamily: "'DM Serif Display', Georgia, serif", fontWeight: 400, fontSize: "28px", color: active === i ? "#fff" : "rgba(255,255,255,0.4)", transition: "color 0.2s" }}>
              {step.title}
            </h3>
